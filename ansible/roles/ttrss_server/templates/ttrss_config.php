<?php
	...
	define('SELF_URL_PATH', 'https://ttrss.{{ inventory_hostname }}/');
	...
	define('REG_NOTIFY_ADDRESS', '{{ email }}');
	...
	define('SMTP_FROM_ADDRESS', 'noreply@ttrss.{{ inventory_hostname }}');
